...
>(({ className, showTooltip = false, tooltipContent, ...props }, ref) => {
  ...
  return (
    <SliderPrimitive.Root
      ...
      {...props}
    >
      <SliderPrimitive.Track className="relative grow overflow-hidden rounded-full bg-white/[0.12] data-[orientation=horizontal]:h-2 data-[orientation=vertical]:h-full data-[orientation=horizontal]:w-full data-[orientation=vertical]:w-2">
        <SliderPrimitive.Range className="absolute bg-amazon-orange data-[orientation=horizontal]:h-full data-[orientation=vertical]:w-full" />
